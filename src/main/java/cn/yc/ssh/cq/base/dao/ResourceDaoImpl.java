...
public class ResourceDaoImpl implements ResourceDao {
    ...
    public Resources createResource(final Resources resource) {
    ...
    public Resources findOne(Long resourceId) {
        ...
        List<Resources> resourceList = jdbcTemplate.query(sql, new BeanPropertyRowMapper(Resources.class), resourceId);
